...
public final class UserListFragment$$InjectAdapter extends Binding<UserListFragment>
  ...
  public UserListFragment$$InjectAdapter() {
    super("com.factati.basedroid.ui.UserListFragment", "members/com.factati.basedroid.ui.UserListFragment", NOT_SINGLETON, UserListFragment.class);
  }
  ...
  public void attach(Linker linker) {
    serviceProvider = (Binding<com.factati.basedroid.BootstrapServiceProvider>) linker.requestBinding("com.factati.basedroid.BootstrapServiceProvider", UserListFragment.class);
    logoutService = (Binding<com.factati.basedroid.authenticator.LogoutService>) linker.requestBinding("com.factati.basedroid.authenticator.LogoutService", UserListFragment.class);
    supertype = (Binding<ItemListFragment>) linker.requestBinding("members/com.factati.basedroid.ui.ItemListFragment", UserListFragment.class, false, true);
  }
