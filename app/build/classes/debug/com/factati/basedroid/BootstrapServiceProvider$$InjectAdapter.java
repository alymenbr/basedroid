...
public final class BootstrapServiceProvider$$InjectAdapter extends Binding<BootstrapServiceProvider>
  ...
  private Binding<com.factati.basedroid.authenticator.ApiKeyProvider> keyProvider;
  private Binding<com.factati.basedroid.core.UserAgentProvider> userAgentProvider;

  public BootstrapServiceProvider$$InjectAdapter() {
    super("com.factati.basedroid.BootstrapServiceProvider", "members/com.factati.basedroid.BootstrapServiceProvider", NOT_SINGLETON, BootstrapServiceProvider.class);
  }
  ...
  public void attach(Linker linker) {
    keyProvider = (Binding<com.factati.basedroid.authenticator.ApiKeyProvider>) linker.requestBinding("com.factati.basedroid.authenticator.ApiKeyProvider", BootstrapServiceProvider.class);
    userAgentProvider = (Binding<com.factati.basedroid.core.UserAgentProvider>) linker.requestBinding("com.factati.basedroid.core.UserAgentProvider", BootstrapServiceProvider.class);
  }
